...
{
    public class NewUsuarioHandler : IRequestHandler<NewUsuarioRequestCommand, ResponseVo>
    {
        private readonly IValidationService _validationService;
        private readonly IUsuarioRepository _usuarioRepository;

        public NewUsuarioHandler(IValidationService validationService,
        ...
        public async Task<ResponseVo> Handle(NewUsuarioRequestCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var newUser = await _usuarioRepository.Add(entity);
                if (newUser != null)
                {
                    response = new ResponseVo(newUser, "Usuário cadastrado com sucesso!");
                }
            }
            catch (Exception ex)
            {
